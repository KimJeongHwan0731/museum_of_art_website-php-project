...
<head>
  ...
  <script src="http://<?= $_SERVER['HTTP_HOST'] ?>/php_source/project/image_board/js/image_board2.js?v=<?= date('Ymdhis') ?>"></script>
      ...
      <form name="image_board_form" method="post" action="image_board_modify.php?num=<?= $num ?>&page=<?= $page ?>" enctype="multipart/form-data">
        <ul id="board_form">
          ...
          <li id="text_area">
            ...
            <span class="col2">
              <textarea name="content"><?= $period ?></textarea>
            </span>
          </li>
          <li>
        ...
        <ul class="buttons">
          <li><button type="button" id="complete2">수정하기</button></li>
