...
if (isset($_POST["mode"]) && $_POST["mode"] === "delete") {
  ...
  $sql = "insert into image_board (id, name, subject, place, period, regist_day, hit, file_name, file_type, file_copied) ";
  $sql .= "values(:userid, :name, :subject, :place, :period, :regist_day, 0, ";
