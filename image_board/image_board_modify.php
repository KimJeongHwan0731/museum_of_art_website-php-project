...
$file_copied = date("Y_m_d_H_i_s") . $upfile_name;
...
$sql = "update image_board set subject=:subject, period=:content, file_name=:upfile_name, file_type=:upfile_type, file_copied= :copied_file_name";
$sql .= " where num=:num";
